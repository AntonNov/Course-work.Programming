...
namespace Soccer
{
    public class Entity
    {
        ...
        public Entity(Size size)
        {
            ...
            sprite = new Bitmap("C:\\Users\\DELL\\Desktop\\Kursach\\Physics\\ball.jpg");
            mySize = size;
        }

        public void DrawSprite(Graphics g)
        {
            //sprite = new Bitmap(RotateImage(sprite));выглядит не очень, в этой версии не используем
            g.DrawImage(sprite, myPhysics.position.X, myPhysics.position.Y, mySize.Width, mySize.Height);
        }

        //крутящийся мяч, выглядит нелепо
